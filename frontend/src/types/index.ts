export interface BuildResult {
  ...
  timestamp: number
  url?: string
  jobUrl?: string          // Jenkins'ten gelen gerçek job URL'i
  ...
  flakyCount?: number
  note?: string
  group: string            // "CI/CD" | "Deployments" | "Deploy Jobs"
  subGroup: string         // "NishCommerce" vb.
  branch: string           // "main" | "test" vb.
}
...
export interface TestHistoryPoint { buildNumber: number; status: 'pass' | 'fail' | 'skip' }
