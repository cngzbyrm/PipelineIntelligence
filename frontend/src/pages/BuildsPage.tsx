...
import {
  Star, XCircle, CircleNotch, MagnifyingGlass, PlugsConnected,
  Trophy, Medal, SealCheck, Confetti, Wrench, ChartBar
    ...
    <div className="page-wrap">
      ...
      <div className="fbar">
        ...
        <div className="fright">
          <select className="sel" value={sort} onChange={e => setSort(e.target.value as SortType)}>
